            ...
            <div className="mt-4 max-w-7xl   ">
                <ul className="gap-3 sm:gap-3  grid grid-cols-4 md:grid-cols-4 lg:grid-cols-8 ">
                    ...
                    {occassion.map((occassion) => (
                        <li key={occassion} >
                            <Button type="button" className="hover:border-[#D4AF37] border border-transparent text-xs sm:text-sm md:text-base lg:text-base " ><span className="px-0 lg:px-2 md:px-3 text-[#D4AF37] playfair-display ">{occassion}</span></Button>
                        </li>
                    ))}
                </ul>
            </div>
