    ...
    return (
        <div ref={ref} className='relative flex flex-col gap-2 w-full '>
            ...
            <button
                ...
                <span className='playfair-display text-[#1D1C1B] text-[14px] sm:text-[16px] md:text-[18px] font-medium italic'>{selected || placeholder}</span>
                {open
                ...
                <ul
                    ...
                    {options.map((option, i) =>
                        <li key={i}
                            ...
                            className={`
                                rounded-xl px-3 sm:px-4 md:px-5 py-2 sm:py-3 playfair italic text-[13px] sm:text-[14px] md:text-base cursor-pointer
