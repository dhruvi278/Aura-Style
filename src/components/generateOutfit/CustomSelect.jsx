  ...
  return (
    <div ref={ref} className="relative flex flex-col gap-2 w-full ">
      <p
        className={
          labelClassname ||
          `text-[11px] sm:text-[12px] md:text-[14px] font-semibold work-sans tracking-[2px] text-[#A8A29E] uppercase`
        }
      >
        {label}
      </p>
      ...
      {open && (
        <ul className="absolute top-[calc(100%+6px)] left-0 right-0 px-1 sm:px-2 bg-[#FDFAF6] border border-[#E7E1CF] rounded-xl overflow-hidden z-50 py-2 flex flex-col gap-1 sm:gap-2">
