...
// function UploadOption({ onUpload, onClose, cameraFacing, uploading }) {
...
//             const file = e.target.files[0];
//             if (!file) return;
//             const category = 'tops';    // ideally from a modal/select — see note below
//             const name = file.name.replace(/\.[^.]+$/, '');
//             onUpload(file, category, name);
//             e.target.value = '';   
//         }
//     };
