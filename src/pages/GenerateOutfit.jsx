...
function GenerateOutfit() {
    return (
        <main className='flex flex-col lg:w-full lg:justify-center lg:items-center gap-5 px-4 sm:px-6 md:px-10 pt-6 sm:pt-8 lg:pt-2 bg-[#E7E1CF]/50 min-h-[calc(100dvh-80px)]'>
