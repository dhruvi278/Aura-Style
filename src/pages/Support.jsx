...
function Support() {
    return (
        <main className='page-enter flex flex-col px-4 md:px-10  xl:px-40 py-8 sm:py-12 md:py-16 xl:py-20 gap-10 sm:gap-16 md:gap-20 lg:gap-30 lg:items-center bg-[#F7F4EF]'>
